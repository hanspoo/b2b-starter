...
import { SignupRequest } from '@starter-ws/auth/api';
...
export function SignupReadPassword({
  next,
  cancel,
  userData,
  companyData,
  ...
  return (
    ...
    >
      ...
      <p>
        Ingrese su contraseña, nunca utilice la misma clave que en el banco.
        Piense en una combinación dificil de adivinar.
      </p>
      <Form.Item
        name="password"
